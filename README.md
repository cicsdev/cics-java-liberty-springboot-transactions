...
Java™ Transaction API (JTA) is descrbed in the [Spring security documentation](https://www.ibm.com/support/knowledgecenter/en/SSGMCP_5.4.0/applications/developing/java/dfhpj2_jta.html)
